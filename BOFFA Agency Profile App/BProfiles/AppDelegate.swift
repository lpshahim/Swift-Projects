...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func buildUserInterface(){
        ...
        let rightSideMenu:TableViewController = mainStoryboard.instantiateViewController(withIdentifier: "TableViewController") as! TableViewController
        ...
        drawerContainer = MMDrawerController(center: mainPageNav, rightDrawerViewController: rightSideMenuNav)
